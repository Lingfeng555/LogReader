...
public class HTTP_Package implements Comparable{
    ...
    private Date date;          // "07/Nov/2016:11:35:01"
     ...
     */
    public HTTP_Package(String ip, Date date, Method method, String headerTitle, String version, String port, String dns, String userAgent) {
        this.ip = ip;
        this.date = date;
        this.method = method;
